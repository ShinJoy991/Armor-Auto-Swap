...
public class CapsuleWardrobeScreen extends AbstractContainerScreen<CapsuleWardrobeMenu> {
    ...
    private void updateButtonTooltip(boolean isEnabled) {
        this.switchModeButton.setMessage(isEnabled ?
                new TextComponent("Activated").withStyle(ChatFormatting.GREEN) :
                new TextComponent("Deactivated").withStyle(ChatFormatting.DARK_GRAY));
    }

    @Override
    public void render(PoseStack p_281745_, int p_282145_, int p_282358_, float p_283566_) {
